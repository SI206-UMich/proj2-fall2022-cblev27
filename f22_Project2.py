...
def get_detailed_listing_database(html_file):
    ...
    for item in call:
        ...
        complete_list.append(item + other)
...
def extra_credit(listing_id):
    ...
    with open('html_files/listing_' + listing_id + '.html', 'r') as f:
        ...
        soup = BeautifulSoup(content, 'html.parser')
        reviews = {}
        date_list = soup.find_all('li', class_="_1f1oir5")
...
class TestCases(unittest.TestCase):
    ...
    def test_write_csv(self):
        ...
        self.assertEqual(csv_lines[-1],['Apartment in Mission District','339','28668414','Pending','Entire Room','2'])
